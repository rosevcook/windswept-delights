...
public final class WDFoods {
    public static final FoodProperties GOAT_SHANKS = new FoodProperties.Builder().nutrition(1).saturationModifier(.1f).fast().build();
    public static final FoodProperties COOKED_GOAT_SHANKS = new FoodProperties.Builder().nutrition(3).saturationModifier(.3f).fast().build();
    public static final FoodProperties WILD_BERRY_POPSICLE = new FoodProperties.Builder().nutrition(4).saturationModifier(.7f).alwaysEdible().fast().effect(() -> new MobEffectInstance(WindsweptEffects.FROST_RESISTANCE, 300, 0), 1f).build();
    public static final FoodProperties LAVENDER_SALAD = new FoodProperties.Builder().nutrition(6).saturationModifier(.6f).build();
    public static final FoodProperties MIMOSA_SOUP = new FoodProperties.Builder().nutrition(7).saturationModifier(.5f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT, FoodValues.MEDIUM_DURATION, 0), 1f).build();
