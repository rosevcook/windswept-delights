...
public class WDItems {
    ...
    public static final DeferredItem<Item> CHESTNUT_RISOTTO = ITEMS.createItem("chestnut_risotto", () -> new FoodRemainderItem(() -> Items.BOWL, PropertyUtil.food(WDFoods.CHESTNUT_RISOTTO).craftRemainder(Items.BOWL).stacksTo(16)));
    public static final DeferredItem<Item> MIMOSA_SOUP = ITEMS.createItem("mimosa_soup", () -> new FoodRemainderItem(() -> Items.BOWL, PropertyUtil.food(WDFoods.MIMOSA_SOUP).craftRemainder(Items.BOWL).stacksTo(16)));
    ...
    public static final DeferredItem<Item> LAVENDER_SALAD = ITEMS.createItem("lavender_salad", () -> new FoodRemainderItem(() -> Items.BOWL, PropertyUtil.food(WDFoods.LAVENDER_SALAD).craftRemainder(Items.BOWL).stacksTo(16)));
